...
public class TCodeGenerator {
    ...
    /**数据库地址*/
    public static String DB_URL = "jdbc:postgresql://localhost:5432/gx_activiti_sample?stringtype=unspecified";
    /**数据库驱动名*/
    ...
    /**参与逆向工程的表名**/
    public static String[] INCLUDE_TABLE_NAMES = new String[]{"t_user","t_leaveform"};
    /**不参与逆向工程的表名**/
